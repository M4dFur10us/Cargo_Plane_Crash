...
class M4D_PlaneCrashLoot
{
	...
	void BuildDefault()
	{
		...
		// --- DEFAULTS (MILITARY BOX UNIFICADA) ---
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("NailBox", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("Pliers", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("Pickaxe", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("Whetstone", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("MetalPlate", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("MetalWire", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("MetalPlate", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("Pliers", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("Shovel", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_9x19_25rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_45ACP_25rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_545x39_20Rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_556x45_20Rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_762x39_20Rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("AmmoBox_762x54_20Rnd", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("PlateCarrierVest", 1.0));
		DefaultMilitaryBoxLoot.Insert(new M4D_PlaneCrashLootEntry("NVGoggles", 1.0));
	}
}
